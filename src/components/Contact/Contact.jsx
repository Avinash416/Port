      ...
      <div className="container contact__container">
        <div className="contact__options">
          ...
          <article className="contact__option" data-aos="fade-up" data-aos-anchor=".contact__container"  data-aos-duration='1600'>
            ...
            <h4>Email</h4>
            <h5 style={{ wordWrap: "break-word"}}>avijadhav416@gmail.com</h5>
            <a href="mailto:avijadhav416@gmail.com" target='_blank'  rel="noreferrer">Email me</a>
          </article>
          ...
          <article className="contact__option" data-aos="fade-up" data-aos-anchor=".contact__container"  data-aos-duration='1300'>
            ...
            <h4>Linkedin</h4>
            <h5>Avinash Jadhav</h5>
            <a href="https://www.linkedin.com/in/avinash-jadhav-1b5b28220/" target='_blank'  rel="noreferrer">Let's connect</a>
          </article>
